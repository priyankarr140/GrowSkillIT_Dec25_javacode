...
public class Program_Assignment {

	public static void main(String[] args) throws Exception{
		// TODO Auto-generated method stub
		ChromeDriver driver=new ChromeDriver();
		driver.get("D:\\2026\\growskillIt\\assignment\\selenium-mission-game.html");
		...
		act.dragAndDropBy(triangle, 0,-10).perform();
		//act.clickAndHold(triangle).dragAndDrop(triangle, square).build().perform();
		Thread.sleep(3000);
